...
export const L = {
  ...
  bigMode: () => t('Big', '超大'),
  modeHint: () => t('Levels: can’t lose, gets harder. Challenge: limited shuffles, you can lose. Big: levels on a board of 204 tiles.',
    '闯关：不会输，越来越难。挑战：洗牌有限，可能会输。超大：204 块的大棋盘闯关。'),
  ...
  keepSafe: () => t('Keep your progress safe 📲', '保存你的进度 📲'),
